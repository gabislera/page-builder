...
const PREVIEW_BASE =
	"<style>html,body{margin:0}body{overflow:hidden;font-family:system-ui,sans-serif}</style>";
		...
		>
			{empty ? (
				<div className="pb-placeholder">
					Bloco HTML vazio. Escreva o código no painel ao lado.
				</div>
			) : (
				<>
