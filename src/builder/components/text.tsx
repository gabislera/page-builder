...
export type TextProps = {
  /** HTML generated by the rich-text editor. */
  html: string;
...
function TextView({ id, props, rootRef, onPropChange }: NodeViewProps<TextProps>) {
  ...
  return (
    <div
      ...
      // biome-ignore lint/security/noDangerouslySetInnerHtml: HTML produced by Tiptap (restricted schema)
...
function InlineRichText({
  ...
  useEffect(() => {
    ...
    // commit when clicking outside the text inside the canvas
  ...
  return (
    <div
      ...
      className={className}
      data-pb-node={id}
      // keep editor shortcuts (Delete, Ctrl+Z) from acting on nodes while typing
