...
function FooterView({ id, props, children, rootRef }: NodeViewProps<FooterProps>) {
  ...
  return (
    ...
    >
      ...
      <div className="pb-footer-inner">
        {children}
        {isEditor && empty ? <div className="pb-placeholder">Arraste colunas, textos e menus para cá</div> : null}
      </div>
    </footer>
  );
}
    ...
    <SettingsTabs
      content={
        <Group title="Layout">
          ...
          <NumberUnitField path="minHeight" label="Altura mínima" units={["px", "vh"]} max={800} />
...
export const Footer: ComponentDefinition<FooterProps> = {
  ...
  defaults: {
    fullWidth: false,
    padding: responsive(sides("64px", "24px", "32px"), undefined, sides("48px", "16px", "24px")),
