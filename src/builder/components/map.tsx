...
import { BorderFields, BoxFields, NumberField, ShadowFields } from "../controls/groups.tsx";
import { NumberUnitField, SwitchField, TextField } from "../controls/inputs.tsx";
import { SettingsTabs } from "../controls/settings-layout.tsx";
import { corners, defaultBorder, defaultBox, defaultShadow } from "../core/defaults.ts";
      ...
      style={
        <>
          <Group title="Dimensões">
            <NumberUnitField path="height" label="Altura" units={["px", "vh"]} min={120} max={900} />
...
export const MapEmbed: ComponentDefinition<MapProps> = {
  ...
  css: (id, p) => {
    ...
    sheet.rule(" > .pb-map-shield").set("position", "absolute").set("inset", "0").set("z-index", "1");
