...
const column = (children: NodeSpec[] = []) => h("Container", containerPresets.stack, children, "Coluna");

const blankColumns = (n: number, template = "", label = ""): SectionTemplate => ({
  ...
  blankColumns(3, "1fr 2fr 1fr", "Central mais larga"),
  {
    ...
    build: () =>
      h(
        "Section",
        {
          padding: responsive(sides("96px", "24px"), undefined, sides("56px", "16px")),
  ...
  },
  {
    ...
    build: () =>
      h(
        "Section",
        {
          padding: responsive(sides("80px", "24px"), undefined, sides("48px", "16px")),
        },
        [
          h(
            "Container",
      ...
      h(
        ...
        [
          ...
          h(
            ...
            ["Resultado rápido", "Suporte próximo", "Garantia total"].map((title) =>
              card([
                h("Heading", {
                  text: title,
                  tag: "h3",
      ...
      h(
        ...
        [
          ...
          h("Button", {
            ...
            hover: {
              background: "color-mix(in srgb, #ffffff 85%, var(--pb-c-primary))",
            },
