...
const hero = (): NodeSpec =>
	section(
		...
		],
		{
			background: darkGlow(),
			padding: r(
				sides("96px", "24px", "112px"),
				undefined,
				sides("56px", "16px", "64px"),
			),
...
const forWho = (): NodeSpec =>
	section("Para quem é", [
		grid(
			...
			[
				picture(
					photo("1522202176988-66273c2fd55f", 1200, 1.1),
					"Alunos estudando juntos",
					{
				...
				stack(
					[
						...heading(
							"Para quem é",
							"Feito para quem quer mudar de vida pela tecnologia",
							undefined,
							{ align: "left" },
						),
						checks([
			...
			grid(
				...
				[
					...
					skill(
						"git-branch",
						"Git e GitHub",
						"Versionamento, pull requests e o fluxo de trabalho usado nas equipes.",
					),
					skill(
						"layout-template",
...
const MODULES: [string, string][] = [
	[
		...
		"Como a internet funciona, HTML semântico, CSS e seu primeiro site no ar.",
	],
	[
		"Módulo 2 · Layouts responsivos",
		"Flexbox, Grid, unidades relativas e design que funciona em qualquer tela.",
	],
	[
	...
	[
		...
		"Promises, async/await, consumo de APIs e organização de código.",
	],
	[
		"Módulo 5 · React",
		"Componentes, props, estado, hooks e rotas em uma aplicação completa.",
	],
	[
		"Módulo 6 · Carreira",
		"Portfólio, currículo, LinkedIn e preparação para entrevistas técnicas.",
	],
];
				...
				[
					stack(
						[
							...
							checks(
								[
									"Ex-líder técnico de front-end",
									"Mentor de mais de 300 devs",
					...
					picture(
						photo("1507003211169-0a1dd7228f2d", 1000, 0.9),
						"Foto do professor",
						{
	...
	section(
		...
		[
			...
			faq([
				...
				[
					"E se eu não gostar?",
					"Você tem 7 dias de garantia incondicional. É só pedir e devolvemos 100% do valor.",
				],
			]),
		],
		{ background: bg(C.surface) },
...
const finalCta = (): NodeSpec =>
	section(
		...
		[
			...
			lead(
				"Garanta sua vaga com a condição de lançamento e comece hoje mesmo.",
				{
					color: white(80),
				},
			),
