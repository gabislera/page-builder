...
const hero = (): NodeSpec =>
  section(
        ...
        [
          stack(
            [
              ...
              title("Como vender todos os dias no Instagram sem depender de anúncios", {
                tag: "h1",
                align: "left",
          ...
          card(
            [
              ...
              lead("Preencha os dados abaixo e receba o link da aula no seu e-mail e WhatsApp.", {
                align: "left",
                size: r("15px"),
                maxWidth: "100%",
              }),
              h(
                "Form",
                {
                  ...
                  inputHeight: r("52px"),
                  gap: r("14px"),
                  successMessage: "Inscrição confirmada! Enviamos o link da aula para o seu e-mail e WhatsApp.",
                  submit: {
    ...
    ],
    {
      ...
      padding: r(sides("80px", "24px"), undefined, sides("40px", "16px", "56px")),
      background: {
        type: "gradient",
        color: C.background,
        gradient: {
    ...
    [
      ...
      grid(
        ...
        [
          ...
          step("02", "Conteúdo que vende", "O calendário de posts e stories que educa, gera desejo e prepara a venda."),
          step(
            "03",
  ...
  section(
    ...
    [
      grid(
        r(2, 1, 1),
        [
          picture(photo("1573496359142-b8d87734a5a2", 1000, 0.85), "Foto da apresentadora", {
...
const finalCta = (): NodeSpec =>
  section(
    ...
    [
      ...
      lead("A sala tem capacidade máxima. Garanta a sua agora e receba o lembrete antes de começar."),
      join(),
    ],
    { gap: r("24px") },
  );
...
export const capturePage = (): NodeSpec[] => [
  ...
  host(),
  finalCta(),
  miniFooter('© 2026 Mariana Costa · Todos os direitos reservados · <a href="#">Privacidade</a>', false),
];
