...
const productHero = (): NodeSpec =>
	section(
		...
		{
			padding: r(
				sides("48px", "24px", "96px"),
				undefined,
				sides("24px", "16px", "56px"),
			),
		},
	);
			...
			grid(
				...
				[
					feature(
						...
						"Reduz até 98% do barulho à sua volta, do escritório ao avião.",
					),
					feature(
						"battery-charging",
						"40 horas de bateria",
					...
					feature(
						"bluetooth",
						"Conexão multiponto",
						"Fique conectado ao celular e ao notebook ao mesmo tempo.",
					),
					feature(
						"feather",
						"Leve e confortável",
						"Apenas 250 g e almofadas macias para usar o dia inteiro.",
					),
				],
...
const mood = (): NodeSpec =>
	section(
		...
		[
			...
			lead(
				"Drivers de 40 mm afinados por engenheiros de áudio, graves profundos e voz cristalina em chamadas.",
				{
					color: white(80),
				},
			),
			...
			[
				...
				stack(
					[
						...heading(
							"Detalhes",
							"Feito para acompanhar a sua rotina",
							undefined,
							{
								align: "left",
							},
			...
			grid(
				...
				[
					kit(
						...
						"899",
						"ou 12x de R$ 74,92",
						["Fone Aura ANC", "Estojo de viagem", "Garantia de 1 ano"],
					),
					kit(
						"Kit 2 unidades",
						"Economize R$ 199",
	...
	section(
		...
		[
			...
			faq([
				...
				[
					"O frete é grátis mesmo?",
					"Sim, para todo o Brasil e em qualquer kit, sem valor mínimo.",
				],
				[
				...
				[
					"Tem garantia?",
					"Sim, 1 ano de garantia contra defeitos de fabricação, com troca direta pela loja.",
				],
			]),
			h(
				"FloatingButtons",
...
const finalCta = (): NodeSpec =>
	section(
		...
		[
			...
			lead(
				"Se não amar, devolva em até 30 dias. A coleta é por nossa conta e o reembolso é integral.",
			),
