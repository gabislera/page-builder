...
export const PAGE_TEMPLATES: PageTemplate[] = [
	{
		...
		description:
			"Curso ou infoproduto: vídeo, benefícios, conteúdo, depoimentos, oferta com contagem e garantia.",
		headerMode: "none",
		footerMode: "none",
		build: salesPage,
	},
	{
		...
		description:
			"Aula gratuita ou e-book: promessa forte e formulário em destaque, sem distrações.",
		headerMode: "none",
		footerMode: "none",
		build: capturePage,
	},
	{
		...
		description:
			"Loja: galeria do produto, preço, kits, avaliações e compra pelo WhatsApp.",
		headerMode: "site",
		footerMode: "site",
		build: productPage,
	},
