...
const pricing2 = (): NodeSpec =>
	section(
		[
			...intro(
				"Mensal ou anual: você escolhe",
				"No plano anual você economiza e garante o preço por 12 meses.",
			),
			grid(
				2,
				[
	...
	section(
		[
			...intro(
				...
				"Resultados reais de clientes que começaram exatamente de onde você está.",
			),
			grid(
				3,
				TESTIMONIALS.map((t) =>
					h("Testimonial", { ...t, layout: "card" }, [], t.name),
				),
				"Depoimentos",
	...
	section(
		[
			...intro(
				...
				"Tudo o que precisa para tirar suas ideias do papel, em um só lugar.",
			),
			grid(
				3,
...
const galleryGrid = (): NodeSpec =>
	section(
		[
			...intro(
				"Nosso trabalho",
				"Uma seleção de projetos recentes. Clique em uma imagem para ampliar.",
			),
			h(
				"Gallery",
				{
