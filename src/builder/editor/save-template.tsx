  ...
  const save = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Modelo salvo", {
        description: 'Está em "Adicionar seção" → Meus modelos, em todos os seus projetos.',
      });
      setOpen(false);
    },
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Uma cópia desta seção vai para "Meus modelos" e pode ser usada em qualquer página dos seus projetos. Mudar
              a seção depois não altera o modelo.
            </DialogDescription>
          </DialogHeader>
          <form
            id="save-template"
          ...
          <DialogFooter>
            ...
            <Button type="submit" form="save-template" disabled={!name.trim() || save.isPending}>
